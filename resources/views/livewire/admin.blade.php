    ...
    <div class="grid grid-cols-5">
        <div class="text-3xl text-primary-blue w-full px-10">
            ...
            <div class="relative my-auto">
                <button wire:click="bukupage" class="my-5 font-bold h-14 w-full">
                    Books
                </button>
            </div>
            @if($transaksipage)
            ...
            @endif
            <div>
                <button wire:click="transaksipage" class="my-5 font-bold h-14 w-full">
                    Transaction
                </button>
            </div>
        </div>
                ...
                <table class="w-full">
                    ...
                    @foreach($bukus as $buku)
                        ...
                        <td class="text-xl font-medium py-3 w-1/4 flex justify-center gap-5">
                            ...
                            <button wire:click="delete({{$buku->id}})" class="h-8">
