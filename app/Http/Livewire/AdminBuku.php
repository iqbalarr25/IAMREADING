...
{
    use WithFileUploads;
    public $buku_id, $bukus,$isbn,$penulis,$judul,$penerbit,$tanggal,$bahasa,$berat,$lebar,$tinggi,$stock,$halaman,$jenis,$harga,$diskon,$deskripsi,$image,$temp_image, $openModal,$search;
    public $edit=false;
    ...
    public function render()
    {
        ...
        return view('livewire.admin.admin-buku');
    }
